...
class Mac802_16BS : public Mac802_16 {
 ...
 public:
  ...
  /**
   * Return the bandwidth perception policy used by the BS
   * @return Pointer to the policy used by the BS
   * @author A Paltrinieri
   */
  PerceptionManagement::BWPerceptionManagementPolicy* getBWPerceptionPolicy ();
 ...
 protected:
  ...
  ///A Paltrinieri
  PerceptionManagement::BWPerceptionManagementPolicy* pBWPerceptionPolicy;
  ////
  ...
  //A Paltrinieri
  unsigned int cCollisionCounter;
  unsigned int cBWReqCollisionCounter;
  unsigned int cTotalBWReqFailCounter;
