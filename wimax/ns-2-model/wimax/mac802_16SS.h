...
class Mac802_16SS : public Mac802_16 {
 ...
 private:
  ...
  //A Paltrinieri
  unsigned int ct16ExpirationCounter;
  unsigned int cBWReqSentCounter;

 public:
  inline void increaseT16ExpirationCounter() {ct16ExpirationCounter++;}
  inline void increaseBWReqSentCounter() {cBWReqSentCounter++;}
  /////
